...
namespace casmacat {
  ...
  template <class C>
  class PluginFactoryExtension: public IPluginFactory<C> {
    IPluginFactory<C> __base;
  public:
    virtual ~PluginFactoryExtension() { };
    virtual int init_base(int argc, char *argv[], Context *context = 0) = 0;
    /**
